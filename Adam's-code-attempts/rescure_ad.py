...
def initial_random_matrix(n, void_ratio, phenol_ratio, coal_ratio):
...
def resin_cure_simulation(n, void_ratio, phenol_ratio, coal_ratio, T, n_iter):
    ...
    state = initial_random_matrix(n, void_ratio, phenol_ratio, coal_ratio)
